    ...
    pub async fn init(&self) -> Result<()> {
        ...
        downloads.set("add", lua.create_async_function(move |_, (url, filename): (String, String)| {
            ...
            async move {
                ...
                let _ = crate::start_download_impl(&app, state.inner(), id.clone(), url, filename, None, None, false, None).await;
        ...
        downloads.set("add_download", lua.create_async_function(move |_, (url, name): (String, String)| {
            ...
            async move {
                ...
                let _ = crate::start_download_impl(&app, state.inner(), id.clone(), url, name.clone(), None, None, false, None).await;
